...
8. **Archive and hand off:** preserve selected rounds, shot lists, picks and full briefs in the private asset library ([storage](../tools/asset-storage.md)), not here. A turnaround can guide modelling in Blender and the suffix can guide downstream prompts; those hand-offs remain unverified. Promote only selected, rights-reviewed assets to a game's private production repo.
